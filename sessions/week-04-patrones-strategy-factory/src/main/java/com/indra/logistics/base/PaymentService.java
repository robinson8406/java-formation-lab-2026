...
/**
 * Servicio refactorizado aplicando los patrones Strategy y Factory.
 * No contiene if-else de métodos de pago ni referencia clases concretas de estrategia,
 * cumpliendo con los principios SRP y OCP.
 */
@Service
