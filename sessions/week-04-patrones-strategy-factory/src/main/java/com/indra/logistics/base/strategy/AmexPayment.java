...
public class AmexPayment implements PaymentStrategy {
    ...
    public String confirmationMessage(BigDecimal amount) {
         if (amount.compareTo(BigDecimal.valueOf(100)) < 0) {
            return "Pago con tarjeta de crédito American Express procesado, monto no aplica comisión bancaria.";
        } else {
            return "Pago con tarjeta de crédito American Express procesado, se aplica comisión bancaria.";
        }
    }
}
